...
INSERT INTO public.portfolio_profile_settings (
  ...
  ARRAY['IT Professional.', 'Full-Stack Engineer.', 'IT Support Specialist.', 'Software Engineer.', 'Network Administrator.', 'IT Executive.', 'UI/UX Designer.', 'Web Developer.', 'Problem Solver.', 'Freelancer.'],
  'IT undergraduate skilled in IT Support, Network Infrastructure, and Full-Stack Software Engineering. I build production web systems, diagnose hardware/network infrastructure, and deliver technical solutions.',
  '3+',
  '6+',
  '40+ Global',
  '3.70',
